...
import { createEvent, updateEvent as updateEventAction } from "@/lib/actions/event.actions";
  ...
  return (
    <Form {...form}>
      ...
      >
              ...
              <FormItem className="w-full">
                <FormControl>
                  <div className="flex-center h-[54px] w-full overflow-hidden rounded-full bg-gray-100 px-4 py-2">
                    ...
                    <Input
                      placeholder="Lokasi Event / Online"
                      {...field}
                      className="input-field"
                    />
                  </div>
                          ...
                          <FormControl>
                            <div className="flex items-center">
                              ...
                              <Checkbox
                                ...
                                checked={field.value}
                                id="isFree"
                                className="mr-2 h-5 w-5 border-2 border-green-400"
                              />
                            </div>
                          </FormControl>
                          <FormMessage />
        ...
        <Button
          className="button col-span-2 rounded-full sm:w-fit bg-green-400 text-white hover:bg-violet-500"
          size="lg"
          type="submit"
